...
class GUIBoard(tk.Frame):
    """ Creates the graphical user interface (GUI) that displays the current state of the board. Users use this GUI to
     select their moves. """
    ...
    def state_update(self, new_board: GameBoard):
    ...
    def send_selected_move(self, move: Move) -> None:
        """
        Sends a move generated by interaction with the GUI to the respective player who was interacting with the GUI.
